...
const QuickInquiryForm = ({ onClose }) => {
    ...
    >
      ...
      >
        ...
        <div className="text-center mb-8">
          <h2 className="font-serif text-4xl text-slate-900">{t('quick_inquiry.title')}</h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid w-full items-center gap-1.5">
            <Label htmlFor="requests">{t('quick_inquiry.initial_requests')}</Label>
            <Textarea id="requests" name="requests" placeholder={t('quick_inquiry.initial_requests')} className="min-h-[120px]" />
          </div>
